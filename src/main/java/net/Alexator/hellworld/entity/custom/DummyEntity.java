...
public class DummyEntity extends Monster implements IAnimatable {
    private AnimationFactory animationFactory = GeckoLibUtil.createFactory(this);
public DummyEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        if (event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.dummy_mele.walk", ILoopType.EDefaultLoopTypes.LOOP));
            return PlayState.CONTINUE;
        }

        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.dummy_mele.idle", ILoopType.EDefaultLoopTypes.LOOP));
        return PlayState.CONTINUE;
    }
