...
public class LilyRenderer extends GeoEntityRenderer<LilyEntity> {
    ...
    @Override
    public RenderType getRenderType(LilyEntity animatable, float partialTick, PoseStack poseStack,
